  ...
  return (
    <div className="mt-8 space-y-6 sm:space-y-8">
      ...
      <div className="rounded-xl border border-zinc-200 p-4 sm:p-5">
        <h2 className="text-sm font-medium">Workspace Info</h2>
        <div className="mt-3 space-y-2 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <span className={hasPassword ? "text-emerald-500" : "text-zinc-400"}>
          ...
          {hasPassword && (
            <div>
              ...
              <input
                ...
                className="mt-1 w-full rounded-lg border border-zinc-200 px-4 py-2 text-sm transition-colors focus:ring-1 focus:ring-zinc-300 focus:outline-none"
              />
            </div>
          )}
          <div>
      ...
      <div className="rounded-xl border border-zinc-200 p-4 sm:p-5">
        ...
        <button
          ...
          disabled={isDeleting}
          className="mt-4 rounded-lg border border-zinc-200 px-3 py-1.5 text-sm font-medium text-red-600 transition-colors hover:bg-red-50 disabled:opacity-50"
        >
