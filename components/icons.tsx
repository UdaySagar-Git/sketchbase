...
export function TrashSimple({ size = 24, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function File({ size = 24, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function GitBranch({ size = 24, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function GripVertical({ size = 24, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PanelLeft({ size = 24, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
